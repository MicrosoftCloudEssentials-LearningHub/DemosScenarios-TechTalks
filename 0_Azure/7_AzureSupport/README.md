...
- [Azure Support Plans Comparison](#azure-support-plans-comparison)
- [Example of how to create support ticket](#example-of-how-to-create-support-ticket)
    - [From the Azure Portal Global Header Opt 1](#from-the-azure-portal-global-header-opt-1)
    - [From a Specific Resource  Opt 2](#from-a-specific-resource--opt-2)
...
> To create a support ticket for Azure OpenAI (or any Azure service), follow these steps using the Azure Portal:
